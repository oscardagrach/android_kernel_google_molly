...
static struct tegra11_emc_table molly_evt_h5tc4g63afr_pba_T40X_table[] = {
	...
	},
	{
		...
		11,         /* number of up_down_regs */
		{
			...
			0x8000015e, /* MC_EMEM_ARB_OUTSTANDING_REQ */
			0x00000001, /* MC_EMEM_ARB_TIMING_RCD */
		...
		{
			0x0000009a, /* MC_PTSA_GRANT_DECREMENT */
			0x00180018, /* MC_LATENCY_ALLOWANCE_G2_0 */
			0x0018001a, /* MC_LATENCY_ALLOWANCE_G2_1 */
			0x001d0020, /* MC_LATENCY_ALLOWANCE_NV_0 */
			0x00000020, /* MC_LATENCY_ALLOWANCE_NV2_0 */
			0x00200020, /* MC_LATENCY_ALLOWANCE_NV_2 */
			0x002a0020, /* MC_LATENCY_ALLOWANCE_NV_1 */
			0x0000002a, /* MC_LATENCY_ALLOWANCE_NV2_1 */
			0x002a002a, /* MC_LATENCY_ALLOWANCE_NV3 */
			0x00ff0088, /* MC_LATENCY_ALLOWANCE_EPP_0 */
			0x00ff00ff, /* MC_LATENCY_ALLOWANCE_EPP_1 */
			0x4E564441, /* System Verification tag */
			0x04010700, /* Reg_tool Version */
			0x02000300, /* DVFS_tool Version */
...
static struct tegra11_emc_pdata molly_evt_h5tc4g63afr_pba_T40X_pdata = {
	.description = "molly_evt_h5tc4g63afr_pba_T40X",
	.tables = molly_evt_h5tc4g63afr_pba_T40X_table,
	.num_tables = ARRAY_SIZE(molly_evt_h5tc4g63afr_pba_T40X_table),
};
